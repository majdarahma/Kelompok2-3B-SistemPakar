...
public class AbsoluteLayout implements LayoutManager2, Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -7213919303788079207L;
protected Hashtable<Component, Object> constraints = new Hashtable<Component, Object>();
  ...
  public Dimension preferredLayoutSize(Container paramContainer) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      AbsoluteConstrains absoluteConstraints = (AbsoluteConstrains)this.constraints.get(component);
  ...
  public void addLayoutComponent(Component paramComponent, Object paramObject) {
    if (!(paramObject instanceof AbsoluteConstrains))
      throw new IllegalArgumentException(); 
